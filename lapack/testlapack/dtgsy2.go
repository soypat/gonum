...
func testSolveDtgsy2(t *testing.T, impl Dtgsy2er, rnd *rand.Rand, trans blas.Transpose, ijob, m, n, lda, ldb, ldc, ldd, lde, ldf int) {
	...
	a.Data = []float64{4.0000, 1.0000, 1.0000, 2.0000, .0000, 3.0000, 4.0000, 1.0000, .0000, 1.0000, 3.0000, 1.0000, .0000, .0000, .0000, 6.0000}
	b.Data = []float64{1.0000, 1.0000, 1.0000, 1.0000, .0000, 3.0000, 4.0000, 1.0000, .0000, 1.0000, 3.0000, 1.0000, .0000, .0000, .0000, 4.0000}
	d.Data = []float64{2.0000, 1.0000, 1.0000, 3.0000, .0000, 1.0000, 2.0000, 1.0000, .0000, .0000, 1.0000, 1.0000, .0000, .0000, .0000, 2.0000}
	e.Data = []float64{1.0000, 1.0000, 1.0000, 2.0000, .0000, 1.0000, 4.0000, 1.0000, .0000, .0000, 1.0000, 1.0000, .0000, .0000, .0000, 1.0000}
	c.Data = []float64{-4.0000, 7.0000, 1.0000, 12.0000, -9.0000, 2.0000, -2.0000, -2.0000, -4.0000, 2.0000, -2.0000, 8.0000, -7.0000, 7.0000, -6.0000, 19.0000}
	f.Data = []float64{-7.0000, 5.0000, .0000, 7.0000, -5.0000, 1.0000, -8.0000, .0000, -1.0000, 2.0000, -3.0000, 5.0000, -3.0000, 2.0000, .0000, 5.0000}
	...
	// printFortranGeneral(a, "a")
	// printFortranGeneral(b, "b")
	// printFortranGeneral(c, "c")
	// printFortranGeneral(d, "d")
	// printFortranGeneral(e, "e")
	// printFortranGeneral(f, "f")
